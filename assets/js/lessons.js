...
const LESSONS_5E_BASE = [
  {
    ...
    lexicon: ["salve" (bonjour), "salvete" (bonjour à tous), "vale" (au revoir), "adsum" (je suis là, je suis présent), "Subura" (Subure), "in via" (sur la route), "amicus" (ami), "canis"(chien)],
    maxScore: LESSONS_SPEC.lessonMax,
    training: [
      ...
      { id: "p1-l1-t6", type: "singleChoice", prompt: "« Niger canis est » signifie :", options: ["Niger est un chien", "Le chien est rigolo", "Niger est un mur", "Niger crie", "Le chien salue"], expected: "Niger est un chien", shuffle: true, points: 1 },
      { id: "p1-l1-t7", type: "textInput", prompt: "Écris en latin : « je suis présent ».", expected: "adsum", points: 1 },
    ],
    production: [
      { id: "p1-l1-p1", type: "textInput", prompt: "Traduis en français : Flavia Suburae habitat", expected: "Flavia habite dans Subure", acceptedAnswers: ["flavia habite à subure", "flavia habite à subura"], answerConfig: { type: "translation-segment", language: "fr", accepted: ["flavia habite à subura", "flavia habite à subura"] }, points: 1 },
      ...
      { id: "p1-l1-p3", type: "textInput", prompt: "Traduis en latin : Marcus salue Flavia", expected: "Marcus Flaviam salutat", acceptedAnswers: ["Marcus Flaviam salutat", "Marcus salutat Flaviam", "Salutat Marcus Flaviam"], answerConfig: { type: "one-of", language: "latin", accepted: ["Marcus Flaviam salutat", "Marcus salutat Flaviam", "Salutat Marcus Flaviam"] }, points: 1 },
    ],
    summary: {
      retains: ["Dans une scène, je repère d’abord qui parle et le verbe.", "Les formules salve/vale structurent la communication."],
      cahier: ["salve / salvete" = bonjour, "vale / valete" = au revoir, "adsum" = je suis là],
  ...
  },
  {
    ...
    lexicon: ["domus" = maison, "insula" = immeuble, "ianua" = porte, "fenestra" = fenêtre, "in domo" = à la maison, "prope" = près, "ante" = devant, "stat" = il / elle se tient, "habitat" = il/elle habite, "manet" = il/elle reste],
    maxScore: LESSONS_SPEC.lessonMax,
    training: [
      { id: "p1-l2-t1", type: "singleChoice", prompt: "Aurelia vit dans une grande maison. Quel nom latin choisir pour 'maison' ?", options: ["domus", "insula", "forum", "taberna", "templum"], expected: "domus", shuffle: true, points: 1 },
      { id: "p1-l2-t2", type: "singleChoice", prompt: "Marcus vit dans un immeuble de quartier. C’est une :", options: ["insula", "domus", "via", "porta", "murus"], expected: "insula", shuffle: true, points: 1 },
    ...
    production: [
      ...
      { id: "p1-l2-p2", type: "textInput", prompt: "Traduis en français : Marcus in insula habitat", expected: "marcus habite dans l'insula", acceptedAnswers: ["marcus habite dans l'insula", "marcus habite dans l'immeuble", "marcus habite dans une insula", "marcus habite dans un immeuble", "marcus habite en insula", "marcus habite en immeuble"], answerConfig: { type: "translation-segment", language: "fr", accepted: ["marcus habite dans l'insula", "marcus habite dans l'immeuble", "marcus habite dans une insula", "marcus habite dans un immeuble", "marcus habite en insula", "marcus habite en immeuble"] }, points: 1 },
      { id: "p1-l2-p3", type: "textInput", prompt: "Traduis en latin : Niger est devant la porte", expected: "Niger ante ianuam stat", acceptedAnswers: ["Niger ante ianuam stat", "Niger stat ante ianuam", "Niger ante ianuam est", "Niger est ante ianuam", "Ante ianuam Niger stat", "Ante ianuam est Niger", Ante ianuam stat Niger", "Ante ianuam Niger est], answerConfig: { type: "one-of", language: "latin", accepted: ["Niger ante ianuam stat", "Niger stat ante ianuam", "Niger ante ianuam est", "Niger est ante ianuam", "Ante ianuam Niger stat", "Ante ianuam est Niger", Ante ianuam stat Niger", "Ante ianuam Niger est] }, points: 1 },
    ],
